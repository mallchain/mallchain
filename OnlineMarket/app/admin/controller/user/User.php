...
class User extends AuthController
{
    ...
    public function edit($uid)
    {
        ...
        $f[] = Form::select('distributor_value','分销级别',$user->getData('distributor_value'))->setOptions(function (){foreach (C("fei_xiao_rank") as $k=>$v){$data[]=$v;}return $data;});
        //$f[] = Form::select('distributor_value','分销级别',$user->getData('distributor_value'))->setOptions([['value'=>0,'label'=>'无','disabled'=>true],['value'=>'a','label'=>'服务商','disabled'=>true],['value'=>'b','label'=>'代理','disabled'=>true],['value'=>'c','label'=>'服务中心','disabled'=>true]]);
    ...
    public function update($uid)
    {
        ...
        $edit['mark'] = $data['mark'];
        $edit['distributor_value'] = $data['distributor_value'];
