                ...
                <div class="table-responsive">
                    <table class="table table-striped  table-bordered">
                        ...
                        <tr>
                            ...
                            {/volist}
                            <td class="text-center">
                                <input type="text" class="input-sm form-control sort" name="sort" value="{$vo.sort}" data-id="{$vo.id}" style="width: 80px;display: inline-block" oninput = "value=value.replace(/[^\d]/g,'')">
                            </td>
                            <td class="text-center">
...
<script>
    ...
    $(".sort").keydown(function (event) {
        if (event.keyCode == 13) {
            ...
            $(this).blur(); //输入框失去焦点
            layList.baseGet(layList.U({a:'sort',p:{id:id,sort:sort}}),function (res) {
                layList.msg(res.msg);
            });
        }
    });
