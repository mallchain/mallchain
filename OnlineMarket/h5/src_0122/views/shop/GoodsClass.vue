<template>
  <div class="productSort">
    ...
    <div class="conter" @scroll.native="onScroll">
      <div v-for="(items, indexs) in category2" :key="indexs"> 
        <div class="listw" v-for="(item, indexs) in items.children" :key="indexs">
...
export default {
  ...
  methods: {
    ...
    asideTap(index) {
       this.category2[0] =this.category[index];
