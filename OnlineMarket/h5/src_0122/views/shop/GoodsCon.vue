    ...
    <div class="wrapper">
      <div class="share acea-row row-between row-bottom">
        <div class="money font-color-red">
          ...
          >
          <div id="header"  v-if="storeInfo.integral_money && storeInfo.integral_money > 0"><img src="@assets/images/integral_money_icon.png" /><span class="integral_money_nmoney"
          >积分可抵扣{{ storeInfo.integral_money }}元</span></div>
