...
Route::group(function () {
    ...
    Route::post('call_back_delivery', 'PublicController/call_back_delivery')->name('call_back_delivery');//发货回调
    Route::post('refund_notify', 'PublicController/refund_notify')->name('refund_notify');//供应链售后回调
    ...
    Route::get('customize/list/:cid', 'store.StoreProductController/customize_list')->name('customizeList');//获取自定义模块的banner图和产品
